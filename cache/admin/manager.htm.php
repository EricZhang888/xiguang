<?php /* Smarty version 2.6.26, created on 2016-02-19 10:24:54
...
">
    <h3><?php if ($this->_tpl_vars['rec'] != 'manager_log' && $this->_tpl_vars['rec'] != 'cloud_account'): ?><a href="<?php echo $this->_tpl_vars['action_link']['href']; ?>
...
unset($_smarty_tpl_vars);
 ?>
    <?php endif; ?>
    <?php if ($this->_tpl_vars['rec'] == 'cloud_account'): ?>
    <div class="cloudAccount">
     <?php if ($this->_tpl_vars['action'] == 'set'): ?>
     <form action="manager.php?rec=cloud_account_post" method="post">
...
" onclick="location.href='manager.php?rec=cloud_account'" />
      <p class="reg"><?php echo $this->_tpl_vars['lang']['cloud_account_register_0']; ?>
 <a href="http://www.douco.com/user/register" target="_blank"><?php echo $this->_tpl_vars['lang']['cloud_account_register']; ?>
</a></p>
     </form>
     <?php else: ?>
...
：<?php echo $this->_tpl_vars['cloud_account']['user']; ?>
     ...
     <a href="manager.php?rec=cloud_account&action=set" class="btn"><?php echo $this->_tpl_vars['lang']['cloud_account_reset']; ?>
</a>
     <a href="manager.php?rec=cloud_account_clean" class="btnGray"><?php echo $this->_tpl_vars['lang']['cloud_account_clean']; ?>
</a>
     <?php endif; ?>
    </div>
    <?php endif; ?>
